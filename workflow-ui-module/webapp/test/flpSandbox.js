		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#fixedassetsdisposalapprovaladwwfworkflowuimodule-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"fixedassetsdisposalapprovaladwwfworkflowuimodule-display": {
								"semanticObject": "fixedassetsdisposalapprovaladwwfworkflowuimodule",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=fixedassetsdisposalapproval.adw.wf.workflowuimodule",
									"url": sap.ui.require.toUrl("fixedassetsdisposalapproval/adw/wf/workflowuimodule")
								}
							}
						}
					}
